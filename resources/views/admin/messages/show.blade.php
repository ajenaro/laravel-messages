            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                            <textarea name="body" id="editor"
                                      ...
                                      placeholder="Contenido del mensaje">{{ old('body', $message->body) }}</textarea>
                ...
                <div class="card-footer">
                    <div class="float-right">
                        @if(Str::endsWith(url()->previous(), 'messages') || Str::contains(url()->previous(), 'users/'))
                        <a href="{{ route('admin.messages.edit', $message) }}" class="btn btn-default"><i class="fas fa-reply"></i> Reply</a>
